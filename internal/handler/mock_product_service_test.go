...
type MockProductService struct {
	...
	GetAllFunc  func(nameFilter string) ([]model.Product, error)
...
func (m *MockProductService) GetAll(nameFilter string) ([]model.Product, error) {
	return m.GetAllFunc(nameFilter)
}
